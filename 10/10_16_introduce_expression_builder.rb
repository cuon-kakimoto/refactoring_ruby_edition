...
# 式ビルダーの導入
# [MEMO]
# - 式ビルダーを導入し、アプリケーション固有のインターフェスを作る
# - インターフェスを独立したものとして理解できるように保ちつつ、流れるようなIFをサポートする
# - Fluent IF用のクラスを作る。RubyっぽいFacedeパターンかな。どっちでも選択できる。
# - CalcQualfyはナニに寄せるかそれが問題だな。いまは以下用にもできる。
########################################
#
require 'uri'
require 'net/http'
